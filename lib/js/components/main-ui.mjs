...
import {
    UIManageFonts
} from './font-manager.typeroof.jsx';
...
import * as MotionStageLayout from './layouts/motion-stage.mjs';
import * as VideoproofArrayLayout from './dev-layouts/videoproof-array.mjs';
import * as VideoproofLayout from './layouts/videoproof.typeroof.jsx';
import * as TypeStage from './layouts/type-stage/index.typeroof.jsx';
import * as Ramp from './layouts/ramp/index.typeroof.jsx';
...
export const Layouts = Object.freeze([
  ...
  , ['Ramp', 'Ramp', Ramp, LAYOUT_GROUP_TYPE_TOOLS]
