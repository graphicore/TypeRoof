...
import { UISelectOrEmptyInput, UINumberAndRangeInput, GenericSelect, StaticNode} from "../generic.mjs";
...
export class UIDynamicStructContainer extends _BaseTypeDrivenContainerComponentMixin(
    ...
    constructor(widgetBus, _zones, injectable, ppsRecord) {
        ...
        const h = widgetBus.domTool.h,
            ...
            localZoneElement = <div class="ui_dynamic_struct_container-children"></div>,
            zones = new Map([..._zones, ["host", hostZoneElement], ["local", localZoneElement]]);
    ...
    constructor(widgetBus, _zones) {
        ...
        this._initWidgets([
            [
                ...
                [],
                StaticNode,
                (<label><span>Grow Columns</span></label>)
            ],
            [
                {
                    zone: "local",
                    activationTest: (getEntry) =>
                        !getEntry("value").isEmpty,
                },
                [["numericValue", "value"]],
