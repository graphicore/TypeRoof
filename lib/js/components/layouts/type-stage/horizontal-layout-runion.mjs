...
export function calculateHorizontalRunion(/*...args*/) {
    // all but columnCount are in EN, columnCount is unitless and >= 1;
    const lineLength = 40,
        columnCount = 2,
        columnGutter = 2,
        marginStart = 3,
    ...
    return {
        ...
        marginStart,
        marginEnd,
        fullWidth: lineLength * columnCount
            + columnGutter * (columnCount - 1)
            + marginStart
            + marginEnd
    };
}
...
export function _calculateHorizontalRunion (availableWidthEn, columnConfig, ) {
